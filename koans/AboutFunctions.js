describe("About Functions", function() {
  ...
  it("should allow extra function arguments", function () {
    ...
    expect(returnFirstArg("first", "second", "third")).toBe("first", undefined, undefined);
    
    function returnSecondArg(firstArg, secondArg) {
      return secondArg;
    }
    
    expect(returnSecondArg("only give first arg")).toBe(undefined, "only give first arg", undefined);
